...
# 加载角色图片
player1_image = pygame.image.load("hero.png")
player2_image = pygame.image.load("hero1.png")
player3_image = pygame.image.load("hero2.png")
player4_image = pygame.image.load("hero3.png")
player5_image = pygame.image.load("hero4.png")
...
if character_selected == "hero":
    ...
    hero_image = pygame.image.load("hero1.png")
elif character_selected == "hero2":
    hero_image = pygame.image.load("hero2.png")
elif character_selected == "hero3":
    hero_image = pygame.image.load("hero3.png")
elif character_selected == "hero4":
    hero_image = pygame.image.load("hero4.png")
...
bgpic = pygame.image.load("map.jpg")
